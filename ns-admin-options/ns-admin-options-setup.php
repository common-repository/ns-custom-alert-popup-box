...
add_action( 'admin_menu', function()  {
    add_menu_page( 'Popup Box', 'Popup Box', 'manage_options', untrailingslashit( dirname( __FILE__ ) ).'/ns_admin_option_dashboard.php', '', plugin_dir_url( __FILE__ ).'img/backend-sidebar-icon.png', 60);
...
/* *** *********************************************************************** *** */
/* *** add menu page and add sub menu page *** */
function nscapb_preprocess_pages($value){
    global $pagenow;
...
add_action('admin_init', 'nscapb_preprocess_pages');
