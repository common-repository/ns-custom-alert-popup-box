...
$link_sidebar = $ns_url_plugin_premium.'?ref-ns=2&campaign=CAPB-sidebar&utm_source='.$ns_menu_label.'%20Sidebar&utm_medium=Sidebar%20dentro%20settings&utm_campaign='.$ns_menu_label.'%20Sidebar%20premium';
$link_bannerino = $ns_url_plugin_premium.'?ref-ns=2&campaign=CAPB-bannerino&utm_source='.$ns_menu_label.'%20Bannerino&utm_medium=Bannerino%20dentro%20settings&utm_campaign='.$ns_menu_label.'%20Bannerino%20premium'; 
$link_bannerone = $ns_url_plugin_premium.'?ref-ns=2&campaign=CAPB-bannerone&utm_source='.$ns_menu_label.'%20Bannerone&utm_medium=Bannerone%20dashboard&utm_campaign='.$ns_menu_label.'%20Bannerone%20premium'; 
$link_promo_theme = $ns_url_theme_promo.'?ref-ns=2&campaign=CAPB-MisterCorporate&utm_source='.$ns_theme_promo_slug.'%20'.$ns_menu_label.'%20Sidebar&utm_medium=Sidebar%20'.$ns_theme_promo_slug.'%20dentro%20settings&utm_campaign='.$ns_theme_promo_slug.'%20'.$ns_menu_label.'%20Sidebar%20premium';
$link_unlock_cookie = $ns_url_plugin_premium.'?ref-ns=2&campaign=CAPB-unlock-cookie&utm_source='.$ns_menu_label.'%20Unlock-cookie&utm_medium=Unlock-cookie&utm_campaign='.$ns_menu_label.'%20Unlock-cookie';
	...
	<div class="postbox nsproversionfbpx4wp">
        <h3 class="titprofbpx4wp"><?php echo $ns_full_name; ?></h3>
	        ...
	        <div class="colprofbpx4wp2">
	        	...
	        	<h2 class="titlefbpx4wp2"><?php _e('Go Premium, get more features and support:</h2><br><br>
